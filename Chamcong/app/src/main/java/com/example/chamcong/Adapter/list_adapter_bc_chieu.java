...
public class list_adapter_bc_chieu extends BaseAdapter {
    final ArrayList<DSBaocao> nhanvien;
    public list_adapter_bc_chieu(ArrayList<DSBaocao> nhanvien) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View viewNV;
        if (view == null) {
            viewNV = View.inflate(viewGroup.getContext(), R.layout.item_baocao_chieu, null);
        } else viewNV = view;
