...
import com.example.chamcong.model.Chamcong;
import com.example.chamcong.model.Nhanvien;

import java.util.ArrayList;

public class list_adapter_bc extends BaseAdapter {
    final ArrayList<Nhanvien> nhanvien;
    public list_adapter_bc(ArrayList<Nhanvien> nhanvien) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View viewNV;
        if (view == null) {
            viewNV = View.inflate(viewGroup.getContext(), R.layout.item_baocao, null);
        } else viewNV = view;
        ...
        ((TextView) viewNV.findViewById(R.id.tvChieu)).setText(String.format("Chiều:%s",nv.getsChieu()));
        return viewNV;
    }
}
